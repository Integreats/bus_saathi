...
part of 'geo_alarm_realm_model.dart';
...
class GeoAlarmRealmModel extends _GeoAlarmRealmModel
  ...
  GeoAlarmRealmModel(
    ...
    if (!_defaultsSet) {
      _defaultsSet = RealmObjectBase.setDefaults<GeoAlarmRealmModel>({
        'isActive': false,
      });
    }
  ...
  @override
  Stream<RealmObjectChanges<GeoAlarmRealmModel>> get changes =>
      RealmObjectBase.getChanges<GeoAlarmRealmModel>(this);

  @override
  GeoAlarmRealmModel freeze() =>
      RealmObjectBase.freezeObject<GeoAlarmRealmModel>(this);

  static SchemaObject get schema => _schema ??= _initSchema();
  static SchemaObject? _schema;
  static SchemaObject _initSchema() {
    RealmObjectBase.registerFactory(GeoAlarmRealmModel._);
    return const SchemaObject(
        ObjectType.realmObject, GeoAlarmRealmModel, 'GeoAlarmRealmModel', [
